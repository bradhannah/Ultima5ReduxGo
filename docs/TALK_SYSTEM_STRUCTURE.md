...
This table documents the TalkCommand constants used in TLK scripts. Each command is represented by a byte value and controls dialogue flow, substitutions, prompts, and engine-internal operations.
...
| Callback Action   | ExtortionAmount                | 0xE0       | Extortion amount (engine-internal)        | Sometimes   | May prompt user for payment or action                 | Yes               | Triggers extortion logic                               |
| Callback Action   | GoToJail                       | 0xE1       | Go to jail (engine-internal)              | No          |                                                       | Yes               | Triggers jail logic                                    |
| Callback Action   | PayGenericExtortion            | 0xE2       | Pay generic extortion (engine-internal)   | Sometimes   | May prompt user for payment or confirmation           | Yes               | Triggers extortion payment logic                       |
| Callback Action   | PayHalfGoldExtortion           | 0xE3       | Pay half gold extortion (engine-internal) | Sometimes   | May prompt user for payment or confirmation           | Yes               | Triggers half-gold extortion logic                     |
| Callback Action   | MakeAHorse                     | 0xE4       | Make a horse (engine-internal)            | No          |                                                       | Yes               | Triggers horse creation logic                          |
...
| Input Expected    | AskName                        | 0x88       | Ask for name                              |             | Yes                                                   | User is prompted to provide a name                      | No                |                                                        |
...
| Workflow          | IfElseKnowsName                | 0x8C       | If/else branch based on name knowledge    |             | No                                                    |                                                         | No                |                                                        |
| Workflow          | StartLabelDef                  | 0x90       | Start label definition                    |             | No                                                    |                                                         | No                |                                                        |
...
| Workflow          | EndScript                      | 0x9F       | End of script                             |             | No                                                    |                                                         | No                |                                                        |
| Workflow          | StartNewSection                | 0xA2       | Start new section                         |             | No                                                    |                                                         | No                |                                                        |
| Workflow          | GotoLabel                      | 0xFD       | Go to label                               | No          |                                                       | No                |                                                        |
| Workflow          | DefineLabel                    | 0xFE       | Define label                              | No          |                                                       | No                |                                                        |
