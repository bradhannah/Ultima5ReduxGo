...
| Ignite Torch             | [Commands.md → Ignite Torch](./Commands.md#ignite-torch)                           | `cmd/ultimav/gamescene_input_*map.go` + `internal/game_state/action_ignite.go`                                         | Yes         | Similar    | Decrements torches and lights torch; dungeon/visibility interactions elsewhere.                                                |
...
| Inns/Horses/Shipwright     | Shops.md       | —        | No          | —          | Not present.                                   |
