...
| Yes         | Klimb (Large)       | [Commands.md → Klimb](./Commands.md#klimb)                                         | `cmd/ultimav/gamescene_input_largemap.go:33,92` + `internal/game_state/action_klimb.go:59-116`       | Similar    | Complete: mountain climbing with grapple check, dexterity tests, fall damage, proper error messages. TODOs: vehicle check, random generators, impassable peaks.      |
...
| Yes         | Klimb — Combat/Dungeon   | [Commands.md → Klimb](./Commands.md#klimb)                             | `internal/game_state/action_klimb.go:118-186`        | Similar    | Complete: ladder up/down with floor transitions, proper messaging. TODOs: bidirectional ladders, combat exit direction setting, floor validation logic.            |
