...
// Helper function to create a minimal MapState for testing
func createTestMapState(t *testing.T) *MapState {
	t.Helper()

	// This would need proper initialization based on your architecture
	// For now, return a minimal MapState that won't crash
	ms := &MapState{}

	// You'll need to initialize LayeredMaps and PlayerLocation
